...
<body>
	<div id="templatemo_header_wrapper">
		<div id="templatemo_header">
			<div id="site_title">
				<h1>
					<a href="http://www.cstpoint.com" target="_parent"> <img
						src="images/templatemo_logo.png" alt="Site Title" style="height: 62px; width: 277px"/>
					</a>
				</h1>
			</div>
			</div>
	...
	<div id="templatemo_content">
			...
			<div class="content_box">
				...
				<td valign="top">
					...
					<form name=F1 onSubmit="return dil(this)" action="adminVerification.jsp">
						<table height="130" cellspacing="10" cellpadding="8">
							<%
							...
							<tr>
								<td>LOGIN NAME:</td>
								<td><input type="text" name="username" style="width: 207px; height: 53px"/></td>
							</tr>

							<tr>
								<td>PASSWORD:</td>
								<td><input type="password" name="password" style="width: 207px; height: 49px"/></td>
							</tr>

							<tr>
								<td></td>
								<td><input type="submit" value="Submit" style="width: 119px; height: 48px; "/> <INPUT
									TYPE=RESET VALUE="CLEAR" style="width: 91px; height: 49px"></td>
							</tr>
		...
		<div id="templatemo_footer" style="width: 528px; ">

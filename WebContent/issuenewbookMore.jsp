				...
				<td valign="top">
					<table width="300" height="250" border="1" align="center">
						<%
							...
							long id = Long.parseLong(ph);

							try {
								Connection con = DatabaseConnection.getCon();
								PreparedStatement ps = con.prepareStatement("select * from BOOKDETAILS where ISBN = '" + id + "' ");
								...
								if (rs.next()) {
									...
									out.print("your given ISBN is wrong");
									request.setAttribute("wrong", "your given ISBN is wrong");
						%>

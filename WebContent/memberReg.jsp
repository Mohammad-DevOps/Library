				...
				<td valign="top">
					<table width="300" border="0" cellspacing="10" cellpadding="0"
						...
						<%
							...
							int status = RegisterUser.register(username, password, repassword, phone, adderess, profession);

							if (status > 0) {

								out.print("New Member has been register");
								request.setAttribute("newmember", "New Member has been register");
						%>
						<jsp:forward page="newmember.jsp"></jsp:forward>
						<%
							}
							else {
								out.print("Sorry try later");
								request.setAttribute("sorrynewmember", "Sorry try later");
						%>

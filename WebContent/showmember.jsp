...
<div id="templatemo_content">
		...
		<%
      	...
      	try {
			...
			PreparedStatement ps=con.prepareStatement("Select * from MEMBERLIST");
			
			ResultSet rs=ps.executeQuery();
			out.print("<font color='blue'>Details of member</font>");
			
			out.print("<td><a href='deleteMember.jsp'>Delete</a></td>");		
			out.print("<tr><th>ID</th><th>NAME</th><th>PASSWORD</th><th>PHONE</th><th>ADDRESS</th><th>PROFESSION</th></tr>");
			while(rs.next()){
				out.print("<tr>");
    ...
    <div id="templatemo_footer">
        ...
        <ul class="footer_menu">
               <li><a href="Home.html">Home</a></li>
                ...
                Copyright © 2048 <a href="#">Shahed.Sazzzad.com</a> 
              </div>
</div>
</body>
</html>